<template>
  <div class='tutorial'>
    ...
    <br><br>
    <h2>Ummm, what do you mean by progressive?</h2>
    ...
    Glad you asked. Vue is also reactive - so when our data changes, Vue takes care of updating it at all the places it's being used.
    <br><br>
    But wait... there's more! Vue is:
    <ol>
      ...
      <li>Maintainable - As you'll see in the "Single File Component" tutorial, Vue makes it effortless to manage complex interfaces as well.</li>
      <li>Testable - This is a prerequisite for any new framework. 🤷‍♂️</li>
    </ol>
    <br>
    ...
    <ul>
      <li>
        ...
        <br>
        In his own words, <q>I figured, what if I could just extract the part that I really liked about Angular and build something really lightweight.</q> And voila, Vue was born.
      </li>
      <li>
